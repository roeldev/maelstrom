...
Maelstrom.init = function($gulp, $addTasks, $customConfig)
{
    ...
    Init.loadPlugins( Init.PLUGIN_DIR );
...
Maelstrom.task = function($taskName, $includeSubTasks)
{
    ...
    if (!_.isUndefined($task))
    {
        ...
        {
            // remove $taskName and $includeSubTasks from the args array
            $args.shift();
            $args.shift();

            // add $taskName back to the beginning of the args array
