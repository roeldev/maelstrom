  ...
  return new Object(
  {
    ...
    'createConfig': function($customConfig)
    {
        var $result        = {},
            ...
            $projectConfig = Confirge.read('maelstrom.json'),
            $customConfig2;
        ...
        if (!_.isEmpty($customConfig))
        {
            ...
            if (!_.isUndefined($customConfig.config))
            {
                $customConfig2 = Confirge.read($customConfig.config);
        ...
        // standaard config extenden met nieuwe custom config obj of custom config file
